...
impl TextRenderer {
    ...
    fn render_buffer_u32(
        ...
        let path_transform = active_transform.map(|t| PathTransform::new(t.a, t.c, t.b, t.d, 0.0, 0.0));
            ...
            for glyph in run.glyphs {
                ...
                let (glyph_data, placement_left, placement_top, placement_w, placement_h) = match path_transform {
                    ...
                    Some(zt) => {
                        ...
                        let t = active_transform.expect("path_transform set implies active_transform set");
