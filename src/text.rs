    ...
    fn render_buffer_u32(
        ...
        for run in buffer.layout_runs() {
            ...
            for glyph in run.glyphs {
                ...
                let path_transform = contour_transform.map(|t| PathTransform::new(t.a, t.c, t.b, t.d, 0.0, 0.0));

                let (glyph_data, placement_left, placement_top, placement_w, placement_h) = match path_transform {
                    None => {
                    ...
                    Some(zt) => {
                        ...
                        let t = contour_transform.expect("path_transform set implies contour_transform set");
